...
public class SauceLabsFactory implements SauceOnDemandAuthenticationProvider {
    ...
    private final String souceTestName;
    ...
    public SauceLabsFactory(String browser, String platform, String souceTestName, Logger log) {
        this.browser = browser.toLowerCase();
        this.platform = platform;
        this.souceTestName = souceTestName;
        this.log = log;
    }
